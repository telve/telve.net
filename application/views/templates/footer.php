            ...
            <div class="span3">
                <div class="row-fluid">
                    <div class="span11">
                        ...
                        <p>Üye olan kullanıcılar <a href="<?php echo base_url('sayfalar/kullanici_sozlesmesi');?>">Kullanıcı Sözleşmesi</a> ve <a href="<?php echo base_url('sayfalar/gizlilik_politikasi');?>" style="color:green;">Gizlilik Politikası</a>'nı kabul etmiş sayılırlar.</p>
                    </div>
...
<div class="container" id="footer-container">
    <div class="row-fluid">
        <div class="span12" style="margin-left: 15%;">
            ...
            <div class="span2 footer_col" style="width: 15%; height: 142px; padding-left:1.5em; border-left:solid 1px rgba(0, 0, 0, .2);">
                <ul class="unstyled">
                    <li style="font-size:16px;"><img class="emoji" src="<?php echo base_url('assets/img/emojis/heart.png');?>" height="20" width="20" title="<3" alt="<3" align="absmiddle"><li>
                    <li><a href="<?php echo base_url('sayfalar/altin');?>" style="color:#9A7D2E;">telvealtın <img class="emoji" src="<?php echo base_url('assets/img/emojis/gold_bar.png');?>" height="20" width="20" title=":altın:" alt=":altın:" align="absmiddle"></a></li>
                    <li><a href="<?php echo base_url('sayfalar/sponsor');?>">telvehediyeler <img class="emoji" src="<?php echo base_url('assets/img/emojis/gift.png');?>" height="20" width="20" title=":hediye:" alt=":hediye:" align="absmiddle"></a></li>
                </ul>
            </div>
        </div>
    </div>
