    ...
    <body>
        ...
        <ul id="header" class="nav nav-tabs" style="background-image: url('<?php if (!empty($header_image)) echo $header_image; ?>')">
            ...
            <?php if ( ($this->uri->segment(1) == 'kullanici') && ($this->uri->segment(2) != 'register') && ($this->uri->segment(2) != 'login') ) { ?>
                <li<?php if ( ($this->uri->segment(3) == '') || is_numeric($this->uri->segment(3)) ) echo ' class="active"'; ?>><a <?php if ( ($this->uri->segment(3) == '') || is_numeric($this->uri->segment(3)) ) echo 'style="color:red;"'; ?> href="<?php echo base_url("kullanici")."/".$this->uri->segment(2)."/"; ?>">özet<?php if ($this->session->userdata('username') == urldecode($this->uri->segment(2))) echo "im"; ?></a></li>
                <li<?php if ($this->uri->segment(3) == 'gonderileri') echo ' class="active"'; ?>><a <?php if ($this->uri->segment(3) == 'gonderileri') echo 'style="color:red;"'; ?> href="<?php echo base_url("kullanici")."/".$this->uri->segment(2)."/gonderileri/"; ?>">gönderileri<?php if ($this->session->userdata('username') == urldecode($this->uri->segment(2))) echo "m"; ?></a></li>
                <li<?php if ($this->uri->segment(3) == 'yorumlari') echo ' class="active"'; ?>><a <?php if ($this->uri->segment(3) == 'yorumlari') echo 'style="color:red;"'; ?> href="<?php echo base_url("kullanici")."/".$this->uri->segment(2)."/yorumlari/"; ?>">yorumları<?php if ($this->session->userdata('username') == urldecode($this->uri->segment(2))) echo "m"; ?></a></li>
                <li<?php if ($this->uri->segment(3) == 'evetoylari') echo ' class="active"'; ?>><a <?php if ($this->uri->segment(3) == 'evetoylari') echo 'style="color:red;"'; ?> href="<?php echo base_url("kullanici")."/".$this->uri->segment(2)."/evetoylari/"; ?>">evetoyları<?php if ($this->session->userdata('username') == urldecode($this->uri->segment(2))) echo "m"; ?></a></li>
                <li<?php if ($this->uri->segment(3) == 'hayiroylari') echo ' class="active"'; ?>><a <?php if ($this->uri->segment(3) == 'hayiroylari') echo 'style="color:red;"'; ?> href="<?php echo base_url("kullanici")."/".$this->uri->segment(2)."/hayiroylari/"; ?>">hayıroyları<?php if ($this->session->userdata('username') == urldecode($this->uri->segment(2))) echo "m"; ?></a></li>
                <?php if ($this->session->userdata('username') == urldecode($this->uri->segment(2))) { ?>
                    <li<?php if ($this->uri->segment(3) == 'favorileri') echo ' class="active"'; ?>><a <?php if ($this->uri->segment(3) == 'favorileri') echo 'style="color:red;"'; ?> href="<?php echo base_url("kullanici")."/".$this->uri->segment(2)."/favorileri/"; ?>">favorilerim</a></li>
                <?php } ?>
            <?php } else { ?>
