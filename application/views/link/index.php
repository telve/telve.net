                ...
                <div class="span12">
                    ...
                    <div class="row-fluid">
                        <div class="left"><!-- style="background-color:#3bb;"-->
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="digg">
									...
									<strong><div id="score" class="text-center" id="show-<?php echo $link_item['id'];?>"><?php echo $link_item['score'];?></div></strong>
						...
						<?php if (empty($link_item['url'])) { ?>
                        	<div class="middle"><a href="<?php echo base_url("")."t/".$link_item['topic']."/comments/".$link_item['id']."/".$link_item['seo_segment']."/";?>"><img class="media-object link-thumbnail" src="<?php echo base_url('assets/img/icons/17837.png');?>"/></a></div>
						<?php } else { ?>
							<div class="middle"><a href="<?php echo $link_item['url'];?>"><img class="media-object link-thumbnail" src="<?php echo $link_item['picurl'];?>" onError="this.src='<?php echo base_url('assets/img/icons/1715.png');?>';"/></a></div>
						<?php }?>

                        <div class="row-fluid">
                            <div class="span8">
								<?php if (empty($link_item['url'])) { ?>
		                        	<div>&nbsp;&nbsp;<strong><a class="link-title" href="<?php echo base_url("")."t/".$link_item['topic']."/comments/".$link_item['id']."/".$link_item['seo_segment']."/";?>"><?php echo $link_item['title']?></a></strong>&nbsp;&nbsp;&nbsp;<span class="link-domain">(text post)</span></div>
								<?php } else { ?>
									<div>&nbsp;&nbsp;<strong><a class="link-title" href="<?php echo $link_item['url'];?>"><?php echo $link_item['title']?></a></strong>&nbsp;&nbsp;&nbsp;<span class="link-domain">(<a href="<?php echo base_url().'domain/'.$link_item['domain'].'/';?>"><?php echo $link_item['domain'];?></a>)</span></div>
								<?php }?>
                                <div>&nbsp;
                                ...
                                <div>
                                    <div class="link-actions">&nbsp;
                                        <strong><a href="<?php echo base_url("")."t/".$link_item['topic']."/comments/".$link_item['id']."/".$link_item['seo_segment']."/";?>"> <?php echo $link_item['comments'];?>&nbsp;comments<span class="glyphicon glyphicon-comment" style="font-size:11px;"></span></a>
										&nbsp;&nbsp;
                                        <a href="#">report<span class="glyphicon glyphicon-flag" style="font-size:12px;"></span></a>
                                        &nbsp;&nbsp;
                                        <a class="sharer" href="javascript:void(0)" onclick="set_share(this)">share<span class="glyphicon glyphicon-share" style="font-size:12px;"></span></a></strong>
                                    </div>
                                </div>
                            </div>
                        </div>
