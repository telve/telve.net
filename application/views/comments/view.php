                        ...
                        <div class="row-fluid">
                            <div class="span8" style="margin-left: 15px;">
        						...
        						<div style="line-height: 14px;">
        							<small class="details">submitted <?php echo human_timing($link_item['created']);?>&nbsp;&nbsp;by <a href="<?php echo base_url('').'user/'.$link_item['username'].'/';?>"><?php echo $link_item['username']?></a>&nbsp;&nbsp;to <a href="<?php echo base_url('').'t/'.$link_item['topic'].'/';?>"><?php echo $link_item['topic']?></a></small>
        						</div>
                                <div>
        						...
        						<div>
        							<div class="link-actions"><strong>
                                        ...
                                        <?php } else { ?>
                                            <a id="<?php echo $link_item['id'];?>" href="javascript:void(0)" onclick="favourite_link(this)" class="login-required">favourite<span class="glyphicon glyphicon-star-empty" style="font-size:13px;"></span></a>
                                        <?php } ?>
                                        &nbsp;&nbsp;
